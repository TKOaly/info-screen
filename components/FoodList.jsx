...
export default function FoodList(initialFoodlists) {
  ...
  const gif = `<div style='position:relative; padding-bottom:calc(56.25% + 44px)'><iframe src='https://gfycat.com/ifr/AgedMiniatureBoto' frameborder='0' scrolling='no' width='100%' height='100%' style='position:absolute;top:0;left:0;' allowfullscreen></iframe></div>`
  const foodClosed = (
  ...
  return (
    <div>
      {!isClosed ? foodCarousel : foodClosed}
    </div>
  )
}
